...
ICON_REPAIRS = "mdi:wrench-alert"  # <--- Nouveau
...
UNIQUE_ID_REPAIRS = "ha_monitoring_repairs_pending_sensor"  # <--- Nouveau
...
TRANSLATION_KEY_REPAIRS = "repairs_pending"  # <--- Nouveau
...
ATTR_CORRECTIONS_EN_ATTENTE = "corrections_en_attente"  # <--- Nouveau
