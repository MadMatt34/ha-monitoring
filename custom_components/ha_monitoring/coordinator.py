...
class HAMonitoringCoordinator(
    ...
    def __init__(
        ...
        self._backup_scan_timestamp_cache: dict[str, datetime] = (
            hass.data[DOMAIN].setdefault(
        ...
        self._last_backup_scan_timestamp: datetime | None = (
            self._backup_scan_timestamp_cache.get(
                entry.entry_id
            )
        )
    ...
    async def _async_update_data(
        ...
        if self._cached_backup_info is None:
            ...
            self._backup_scan_timestamp_cache[self.entry.entry_id] = self._last_backup_scan_timestamp
